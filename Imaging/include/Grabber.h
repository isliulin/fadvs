...
namespace _DSHOWLIB_NAMESPACE
{
	 ...
	 * @return true on success, false otherwise.
	 */
	_UDSHL_EXP_API bool	InitLibrary( const char* pSerialNumber, DWORD coinitmode = COINIT_MULTITHREADED );
	/** This function must be used to initialize the library.
	 ...
	 * @return true on success, false otherwise.
	 */
	_UDSHL_EXP_API bool	InitLibrary( const char** ppSerialNumber, unsigned int count, DWORD coinitmode = COINIT_MULTITHREADED );
