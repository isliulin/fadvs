...
typedef enum GENICAM_ECameraAccessPermission
{
	...
	accessPermissionControl,       ///< \~chinese 非独占可读访问权限  ///< \~english Non-Exclusive Readable Access Permission
...
/// GENICAM_Frame The frame which will be active pushed out during the callback, when this frame is used externally then it is required to be released
...
typedef struct GENICAM_EnumNode
{
	...
	/// \param [in] thiz this pointer
	/// \param [out] ppSymbolList  get the configurable symbol's value list, maximum length of chars is 256
	/// \param [out] ppSymbolList  get the number of configurable symbol's value list, maximum number is 1000
